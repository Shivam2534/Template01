      ...
      <Box>
        <Container maxWidth="lg" sx={{ pt: 15, pb: 10 }}>
          ...
          >
            ...
            <Typography
              align="center" // This will center the text horizontally
              sx={{
                color: "rgba(255,255,255,0.7)",
                maxWidth: "800px",
                mx: "auto", // This centers the element horizontally by setting left and right margins to auto
                mb: 6,
                lineHeight: 1.2,
                fontSize: { xs: "22px", sm: "18px", md: "22px" },
                textAlign: "center", // Ensures text is centered inside the Typography element
              }}
            >
      ...
      >
        <Container maxWidth="lg">
          <Typography
            align="center"
            sx={{
              fontSize: { xs: "20px", sm: "30px", md: "35px" }, // Correct responsive fontSize syntax
              mb: 8,
              fontWeight: 600,
            }}
          >
